...
namespace Bookstore
{
    ...
    internal sealed class Bookstore : StatefulService, IBookstore
    {
        ...
        public async Task<string> ListAvailableItems()
        {
            var b = "ccc";
            ...
            //var books = await StateManager.GetOrAddAsync<IReliableDictionary<int, Book>>("bookDictionary");

            //using (var tx = StateManager.CreateTransaction())
            //{
            //    var enumerate = (await books.CreateEnumerableAsync(tx)).GetAsyncEnumerator();
            //    try
            //    {
            //        while (await enumerate.MoveNextAsync(new CancellationToken()))
            //        {
            //            currentBookList.Append(JsonConvert.SerializeObject(enumerate.Current.Value));
            //        }
            //    }
            //    catch (Exception e)
            //    {
